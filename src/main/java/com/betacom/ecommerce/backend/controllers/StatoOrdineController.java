...
@RestController
@RequestMapping("/rest/stato_ordine")
public class StatoOrdineController {
	private final IStatoOrdineServices staS;
	private final IMessagesServices msgS;

	@PostMapping("/create")
    public ResponseEntity<Response> create(@RequestBody(required = true) StatoOrdineRequest req) {
	...
	@PutMapping("/update")
    public ResponseEntity<Response> update(@RequestBody(required = true) StatoOrdineRequest req) {
		Response r = new Response();
        HttpStatus status = HttpStatus.OK;
        try {
            staS.update(req);
