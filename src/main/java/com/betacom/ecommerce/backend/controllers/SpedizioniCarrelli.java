...
@RestController
@RequestMapping("rest/spedizioni")
public class SpedizioniCarrelli {
	private final ISpedizioniServices speS;
	private final IMessagesServices msgS;
	
	@PostMapping("/create")
	public ResponseEntity<Response> create(@RequestBody(required=true) SpedizioniReq req){
	...
	@PostMapping("/update")
	public ResponseEntity<Response> update(@RequestBody(required=true) SpedizioniReq req){
		Response r = new Response();
		HttpStatus status = HttpStatus.OK;
		try {
			speS.update(req);
