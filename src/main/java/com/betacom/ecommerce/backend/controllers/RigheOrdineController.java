...
@RestController
@RequestMapping("/rest/righeordine")
public class RigheOrdineController {
	private final IRigheOrdineServices rowS;
	private final IMessagesServices msgS;

	@PostMapping("/create")
    public ResponseEntity<Response> create(@RequestBody(required = true) RigheOrdineRequest req) {
	...
	@PutMapping("/update")
    public ResponseEntity<Response> update(@RequestBody(required = true) RigheOrdineRequest req) {
		Response r = new Response();
        HttpStatus status = HttpStatus.OK;
        try {
            rowS.update(req);
