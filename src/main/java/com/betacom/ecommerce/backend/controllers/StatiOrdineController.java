...
@RestController
@RequestMapping("/rest/statiordine")
public class StatiOrdineController {
	private final IStatiOrdineServices staS;
	private final IMessagesServices msgS;

	@PostMapping("/create")
    public ResponseEntity<Response> create(@RequestBody(required = true) StatiOrdineRequest req) {
	...
	@PutMapping("/update")
    public ResponseEntity<Response> update(@RequestBody(required = true) StatiOrdineRequest req) {
		Response r = new Response();
        HttpStatus status = HttpStatus.OK;
        try {
            staS.update(req);
