...
@RequestMapping("/rest/generi")
public class GeneriController {
	
	private final IGeneriServices genS;
	private final IMessagesServices msgS;
	
	@PostMapping("/create")
	public ResponseEntity<Response> create(@RequestBody (required = true) GeneriRequest req){
	...
	@PutMapping("/update")
	public ResponseEntity<Response> update(@RequestBody (required = true) GeneriRequest req){
		Response r = new Response();
		HttpStatus status = HttpStatus.OK;
		try {
			genS.update(req);
