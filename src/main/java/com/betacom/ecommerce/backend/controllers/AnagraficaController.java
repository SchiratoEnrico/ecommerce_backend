...
public class AnagraficaController {
	...
	@PostMapping("/create")
    public ResponseEntity<Response> create(@RequestBody(required = true) AnagraficaRequest req) {
	...
	@PutMapping("/update")
    public ResponseEntity<Response> update(@RequestBody(required = true) AnagraficaRequest req) {
        Response r = new Response();
        HttpStatus status = HttpStatus.OK;
