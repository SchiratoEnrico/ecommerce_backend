...
public class OrdiniController {
	...
	@PostMapping("/create")
    public ResponseEntity<Response> create(@RequestBody(required = true) OrdiniRequest req) {
	...
	@PutMapping("/update")
    public ResponseEntity<Response> update(@RequestBody(required = true) OrdiniRequest req) {
		Response r = new Response();
        HttpStatus status = HttpStatus.OK;
        try {
            ordS.update(req);
