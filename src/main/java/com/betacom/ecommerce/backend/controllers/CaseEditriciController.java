...
@RestController
@RequestMapping("rest/case_editrici")
public class CaseEditriciController {

	private final ICaseEditriciServices casS;
	private final IMessagesServices msgS;
	
	@PostMapping("/create")
	public ResponseEntity<Response> create(@RequestBody(required=true) CaseEditriciReq req){
	...
	@PostMapping("/update")
	public ResponseEntity<Response> update(@RequestBody(required=true) CaseEditriciReq req){
		Response r = new Response();
		HttpStatus status = HttpStatus.OK;
		try {
			casS.update(req);
