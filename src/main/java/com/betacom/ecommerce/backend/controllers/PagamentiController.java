...
public class PagamentiController {
	...
	@PostMapping("/create")
    public ResponseEntity<Response> create(@RequestBody(required = true) PagamentiRequest req) {
	...
	@PutMapping("/update")
    public ResponseEntity<Response> update(@RequestBody(required = true) PagamentiRequest req) {
        Response r = new Response();
        HttpStatus status = HttpStatus.OK;
